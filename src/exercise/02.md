...
React supports multiple platforms (for example: browser, mobile and VR) and each
of these platforms has its own code necessary for interacting with that
platform, and then there’s shared code between the platforms.

There are two modules used to build React apps for the web:
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=victorpll10%40gmail.com).
